...
from Optimize_Grades import optimize_grade_square_dist
from Optimize_Grades import calculate_avg_distance_from_optimal

'''
    Read Data
'''
alternative_map, alt_names, df_crowd, df_expert, _ = read_data_credibility()
...
all_exp_grades, all_crowd_grades = prepare_data_for_grade_optimization(all_pred, test_combinations, df_expert, df_crowd, voters_lookup, expert_ids, crowd_ids)


'''
Optimize grade square
