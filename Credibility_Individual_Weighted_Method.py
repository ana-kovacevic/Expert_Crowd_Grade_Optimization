...
df_crd_votes = df_alt_votes[crowd_ids].T
...
W_crowd_selection = calculate_alternatives_scores_and_get_selection(df_crd_votes[alt_names], 0, crowd_weights = crd_user_weights)[0]


all_user_weights = get_voter_weights_by_distance(user_factors, user_factors[expert_ids])[1]
W_all_selection = calculate_alternatives_scores_and_get_selection(df_alt_votes.T[alt_names], 0, crowd_weights = all_user_weights)[0]
